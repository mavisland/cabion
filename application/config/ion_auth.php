 ...
 * Original Author name has been kept but that does not mean that the method
...
/*
 ...
 |
 | Argon2 is recommended by expert (it is actually the winner of the Password
 | Hashing Competition for more information see https://password-hashing.net).
 | So if you can (PHP 7.2), go for it.
 |
 | Bcrypt specific:
 |      bcrypt_default_cost settings:  This defines how strong the encryption
 |      will be. However, higher the cost, longer it will take to hash (CPU
 |      usage) So adjust this based on your server hardware.
 |
 |      You can (and should!) benchmark your server. This can be done easily
 ...
 |
 |      A specific parameter bcrypt_admin_cost is available for user in admin
 |      group. It is recommended to have a stronger hashing for administrators.
 |
 | Argon2 specific:
